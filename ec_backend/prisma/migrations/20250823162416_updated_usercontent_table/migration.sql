...
*/
-- AlterTable
ALTER TABLE `user` MODIFY `avatarUrl` VARCHAR(250) NULL DEFAULT 'https://englishconversations-files.s3.us-east-1.amazonaws.com/images/avatar_placeholder.png',
...
-- AlterTable
ALTER TABLE `usercontent` ADD COLUMN `Notes` TEXT NULL,
