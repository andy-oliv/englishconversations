/*
  ...
  - You are about to drop the column `isCompleted` on the `quizhistory` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `quizhistory` DROP COLUMN `isCompleted`,
