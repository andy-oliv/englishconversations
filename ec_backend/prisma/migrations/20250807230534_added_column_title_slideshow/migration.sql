/*
  ...
  - Added the required column `title` to the `Slideshow` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `slideshow` ADD COLUMN `title` VARCHAR(100) NOT NULL;
