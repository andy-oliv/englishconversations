/*
  ...
  - Added the required column `description` to the `Slideshow` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `slideshow` ADD COLUMN `description` TEXT NOT NULL;
