...
import styles from "./styles/UnscrambleWord.module.scss";
...
export default function UnscrambleWord({
  exercise,
  ...
  return (
    <>
      ...
      <h1 className={styles.title}>Unscramble the word</h1>
