...
*/
-- DropForeignKey
ALTER TABLE `answeredexercise` DROP FOREIGN KEY `AnsweredExercise_userId_fkey`;
...
-- AddForeignKey
ALTER TABLE `AnsweredExercise` ADD CONSTRAINT `AnsweredExercise_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
